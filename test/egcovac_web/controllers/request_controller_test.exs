defmodule EgcovacWeb.RequestControllerTest do
  use EgcovacWeb.ConnCase

  alias Egcovac.Requests

  @create_attrs %{appointment: ~D[2010-04-17], registration_number: "some registration_number"}
  ...
  describe "update request" do
    ...
    test "redirects when data is valid", %{conn: conn, request: request} do
      ...
      assert html_response(conn, 200) =~ "some updated registration_number"
    end
