defmodule EgcovacWeb.UserControllerTest do
  use EgcovacWeb.ConnCase

  alias Egcovac.Users

  @create_attrs %{birth_date: ~D[2010-04-17], category: "some category", city: "some city", email: "some email", gender: "some gender", job: "some job", name: "some name", nid: "some nid", phone: "some phone", weight_index: 120.5}
